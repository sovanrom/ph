...
class Contacting extends MY_Controller {
	...
	{
		$data['scripts'] = array('contracting');
		$data['active'] = 'contracting';
		$data['title'] = 'contracting';
		$data['content'] = 'fleet/contracting/index';
	...
	public function create()
	{
		if (!empty($this->input->post())) {
			$manage_building = array(
				'building_name_en' => $this->input->post('building_name'),

$(function () {
    ...
    var $modal = $('#my_modal');
     ...
     $('li.buildings').addClass('opened active').find('ul').addClass('visible').find('li.floors').addClass('active');
    ...
    function createUpdate() {
        $.ajax({
            url: $('#form_floor').attr('action'),
            type: 'POST',
            dataType: 'json',
            data: new FormData($('#form_floor')[0]),
            processData: false,
            contentType: false,
            success: function(response) {

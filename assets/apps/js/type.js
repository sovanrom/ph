$(function () {
    ...
    $('li.settings').addClass('opened active').find('ul').addClass('visible').find('li.types').addClass('active');
    ...
    function createUpdate() {
        $.ajax({
            url: $('#form_type').attr('action'),
            type: 'POST',
            dataType: 'json',
            data: new FormData($('#form_type')[0]),
            processData: false,
            contentType: false,
            success: function(response) {

$(function () {
    ...
    $('li.settings').addClass('opened active').find('ul').addClass('visible').find('li.vendors').addClass('active');
    ...
    function createUpdate() {
        $.ajax({
            url: $('#form_vendor').attr('action'),
            type: 'POST',
            dataType: 'json',
            data: new FormData($('#form_vendor')[0]),
            processData: false,
            contentType: false,
            success: function(response) {
